    ...
    public void kaynnista() throws SQLException {
        while (true) {
            ...
            if(komento.equals("1")) {
                ...
                this.tietokanta.listaa()
                        .forEach(kanta -> System.out.println(kanta));
            }
            ...
            if(komento.equals("3")) {
                ...
                int tehtyId = lukija.nextInt();
                tietokanta.asetaTehdyksi(tehtyId);
            }
            ...
            if(komento.equals("4")) {
                ...
                this.tietokanta.poista(poistettava);
            }
        }
