...
public class UseampiNakyma extends Application{
    ...
    public static void main(String[] args) {
        System.out.println("Ohjelma käynnistyy!");
    ...
    public void start(Stage ikkuna) {
        // ekaNakyma
        BorderPane ekaAsetelma = new BorderPane();
        
        ekaAsetelma.setTop(new Label("Eka näkymä!"));
        Button tokaan = new Button("Tokaan näkymään!");
        ekaAsetelma.setCenter(tokaan);
        ...
        Scene ekaNakyma = new Scene(ekaAsetelma);
