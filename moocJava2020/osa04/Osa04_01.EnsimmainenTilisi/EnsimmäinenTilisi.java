 ...
 * Luokan Tili olio esittää pankkitiliä,
 * jolla on saldo (eli jossa on jokin määrä rahaa).
 * Tilejä käytetään näin:
 *
 ...
 * System.out.println(artonSveitsilainenTili);
 *
 * Tee ohjelma, joka luo tilin jonka saldo on 100.0,
 * panee tilille 20.0 ja tulostaa tilin.
 * Huom! tee kaikki nämä operaatiot täsmälleen tässä järjestyksessä.
 *
 */
